...
if glCompileShaderARB and OpenGL.ERROR_CHECKING:
	glCompileShaderARB.errcheck = _afterCheck( GL_OBJECT_COMPILE_STATUS_ARB )
if glLinkProgramARB and OpenGL.ERROR_CHECKING:
...
if glGetInfoLogARB:
	...
	def glGetInfoLogARB( obj ):
		...
		"""
		length = glGetObjectParameterivARB(obj, GL_INFO_LOG_LENGTH_ARB)
		if length > 0:
