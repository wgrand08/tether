...
if simple.glGetConvolutionFilter:
	def glGetConvolutionFilter( target, format, type ):
		...
		simple.glGetConvolutionFilter( 
			target, format, type,
			ctypes.c_void_p( arrayType.dataPointer(array))
		)
		return array
if simple.glGetSeparableFilter:
...
if simple.glGetColorTable:
	def glGetColorTable( target, format, type ):
		...
		simple.glGetColorTable( 
			target, format, type,
			ctypes.c_void_p( arrayType.dataPointer(array))
		)
		return array
if simple.glGetHistogram:
