...
if glCompileShader and OpenGL.ERROR_CHECKING:
	glCompileShader.errcheck = _afterCheck( GL_OBJECT_COMPILE_STATUS )
if glLinkProgram and OpenGL.ERROR_CHECKING:
...
if glGetShaderSource:
	...
	def glGetShaderSource( obj ):
		...
		"""
		length = glGetObjectParameteriv(obj, GL_OBJECT_SHADER_SOURCE_LENGTH)
		if length > 0:
...
if glGetActiveUniform:
	...
	def glGetActiveUniform(program, index):
		...
		max_index = glGetObjectParameteriv( program, GL_OBJECT_ACTIVE_UNIFORMS )
		length = glGetObjectParameteriv( program, GL_OBJECT_ACTIVE_UNIFORM_MAX_LENGTH)
